...
if page == "Topic Modeling Visualizer":
    ...
    st.markdown("<p style='font-size: 18px; margin-top: 30px;'>🔍 Click on any topic bubble to explore its most representative keywords interactively.</p>", unsafe_allow_html=True)
